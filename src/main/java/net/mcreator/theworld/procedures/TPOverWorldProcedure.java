...
public class TPOverWorldProcedure extends TheWorldModElements.ModElement {
	public TPOverWorldProcedure(TheWorldModElements instance) {
		super(instance, 74);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheWorldMod.LOGGER.warn("Failed to load dependency entity for procedure TPOverWorld!");
			return;
		}
