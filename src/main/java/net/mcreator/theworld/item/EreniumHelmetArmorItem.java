...
public class EreniumHelmetArmorItem extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:erenium_helmet_armor")
	public static final Item block = null;
	public EreniumHelmetArmorItem(TheWorldModElements instance) {
		super(instance, 43);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("erenium_helmet_armor");
		}
