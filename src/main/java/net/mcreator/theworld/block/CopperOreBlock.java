...
import net.mcreator.theworld.item.CopperIngotItem;
...
public class CopperOreBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TheWorldModElements instance) {
		super(instance, 24);
	}
