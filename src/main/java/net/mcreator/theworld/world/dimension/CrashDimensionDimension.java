...
import net.mcreator.theworld.block.ToxicFluidBlock;
...
public class CrashDimensionDimension extends TheWorldModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_world:crash_biome_apo")),};
	}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return ToxicFluidBlock.block.getDefaultState();
				}
			});
