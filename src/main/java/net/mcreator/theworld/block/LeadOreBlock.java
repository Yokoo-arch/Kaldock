...
import net.mcreator.theworld.item.LeadIngotItem;
...
public class LeadOreBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:lead_ore")
	public static final Block block = null;
	public LeadOreBlock(TheWorldModElements instance) {
		super(instance, 30);
	}
