...
public class DeadFlowerBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:dead_flower")
	public static final Block block = null;
	public DeadFlowerBlock(TheWorldModElements instance) {
		super(instance, 82);
	}
