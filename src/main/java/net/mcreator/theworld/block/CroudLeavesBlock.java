...
public class CroudLeavesBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:croud_leaves")
	public static final Block block = null;
	public CroudLeavesBlock(TheWorldModElements instance) {
		super(instance, 71);
	}
