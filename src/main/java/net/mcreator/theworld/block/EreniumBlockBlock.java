...
public class EreniumBlockBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:erenium_block")
	public static final Block block = null;
	public EreniumBlockBlock(TheWorldModElements instance) {
		super(instance, 3);
	}
