...
import net.mcreator.theworld.item.SilverIngotItem;
...
public class SilverOreBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(TheWorldModElements instance) {
		super(instance, 36);
	}
