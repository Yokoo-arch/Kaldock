...
public class EreniumJambiereItem extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:erenium_jambiere")
	public static final Item block = null;
	public EreniumJambiereItem(TheWorldModElements instance) {
		super(instance, 45);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("erenium_jambiere");
		}
