...
import net.mcreator.theworld.world.dimension.KirbiDimension;
...
public class TPKirbiProcedure extends TheWorldModElements.ModElement {
	public TPKirbiProcedure(TheWorldModElements instance) {
		super(instance, 67);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheWorldMod.LOGGER.warn("Failed to load dependency entity for procedure TPKirbi!");
			return;
		}
			...
			((PlayerEntity) entity).closeScreen();
		{
			...
			if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
				DimensionType destinationType = KirbiDimension.type;
