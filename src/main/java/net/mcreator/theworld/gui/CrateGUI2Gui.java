...
public class CrateGUI2Gui extends TheWorldModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CrateGUI2Gui(TheWorldModElements instance) {
		super(instance, 76);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("the_world:textures/crate_gui_2.png");
		@Override
