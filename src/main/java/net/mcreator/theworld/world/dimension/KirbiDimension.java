...
public class KirbiDimension extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:kirbi")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public KirbiDimension(TheWorldModElements instance) {
		super(instance, 65);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("kirbi"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("the_world:kirbi")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("the_world:kirbi"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("the_world:kirbi"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_world:kirbi_biome")),
