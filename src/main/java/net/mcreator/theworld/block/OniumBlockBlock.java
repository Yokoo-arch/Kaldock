...
public class OniumBlockBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:onium_block")
	public static final Block block = null;
	public OniumBlockBlock(TheWorldModElements instance) {
		super(instance, 42);
	}
