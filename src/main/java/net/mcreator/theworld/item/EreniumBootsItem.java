...
public class EreniumBootsItem extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:erenium_boots")
	public static final Item block = null;
	public EreniumBootsItem(TheWorldModElements instance) {
		super(instance, 46);
	}
