...
public class CroudDimension extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:croud")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public CroudDimension(TheWorldModElements instance) {
		super(instance, 68);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("croud"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("the_world:croud")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("the_world:croud"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("the_world:croud"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("jungle")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_world:croud_biome_jungle_custom")),};
	}
	...
	public static class CustomDimension extends Dimension {
		...
		public Vec3d getFogColor(float celestialAngle, float partialTicks) {
			return new Vec3d(0.003921568627, 0.337254901961, 0.043137254902);
		}
