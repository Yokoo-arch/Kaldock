...
public class CopperBlockBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(TheWorldModElements instance) {
		super(instance, 25);
	}
