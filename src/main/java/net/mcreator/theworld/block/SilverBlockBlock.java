...
public class SilverBlockBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(TheWorldModElements instance) {
		super(instance, 37);
	}
