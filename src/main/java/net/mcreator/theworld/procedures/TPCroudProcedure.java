...
import net.mcreator.theworld.world.dimension.CroudDimension;
...
public class TPCroudProcedure extends TheWorldModElements.ModElement {
	public TPCroudProcedure(TheWorldModElements instance) {
		super(instance, 68);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheWorldMod.LOGGER.warn("Failed to load dependency entity for procedure TPCroud!");
			return;
		}
			...
			((PlayerEntity) entity).closeScreen();
		{
			...
			if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
				DimensionType destinationType = CroudDimension.type;
