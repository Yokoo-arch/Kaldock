...
public class EreniumPickaxeItem extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:erenium_pickaxe")
	public static final Item block = null;
	public EreniumPickaxeItem(TheWorldModElements instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("erenium_pickaxe"));
	}
}
