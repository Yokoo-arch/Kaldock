...
public class EreniumSwordItem extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:erenium_sword")
	public static final Item block = null;
	public EreniumSwordItem(TheWorldModElements instance) {
		super(instance, 14);
	}
