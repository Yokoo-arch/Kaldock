...
import net.mcreator.theworld.procedures.CrateNextGUIProcedure;
...
public class CrateGUIGui extends TheWorldModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CrateGUIGui(TheWorldModElements instance) {
		super(instance, 76);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("the_world:textures/crate_gui.png");
		@Override
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 119, this.guiTop + 61, 45, 20, "NEXT", e -> {
				if (true) {
		...
		if (buttonID == 0) {
			{
				...
				CrateNextGUIProcedure.executeProcedure($_dependencies);
			}
		}
	}
