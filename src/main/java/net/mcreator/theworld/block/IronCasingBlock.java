...
public class IronCasingBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:iron_casing")
	public static final Block block = null;
	public IronCasingBlock(TheWorldModElements instance) {
		super(instance, 78);
	}
