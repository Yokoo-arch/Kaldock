...
public class DeadPlantsBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:dead_plants")
	public static final Block block = null;
	public DeadPlantsBlock(TheWorldModElements instance) {
		super(instance, 81);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new DefaultFlowersFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				if (dimensionType == KirbiDimension.type)
