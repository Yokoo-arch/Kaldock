...
public class CroudLogBlock extends TheWorldModElements.ModElement {
	@ObjectHolder("the_world:croud_log")
	public static final Block block = null;
	public CroudLogBlock(TheWorldModElements instance) {
		super(instance, 70);
	}
